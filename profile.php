...
$query=mysqli_query($bd, "update users set fullName='$fname',contactNo='$contactno',address='$address',State='$state',country='$country',pincode='$pincode',producer='$producer',woreda='$woreda',zones='$zone' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<div class="col-sm-4">
<input type="text" name="producer" id="producer"  required="required" value="<?php echo htmlentities($row['producer']);?>" class="form-control">
</div>
<label class="col-sm-2 col-sm-2 control-label"><b style="color:red;">*</b> Full Name</label>
<div class="col-sm-4">
<input type="text" name="fullname" id="person" required="required" value="<?php echo htmlentities($row['fullName']);?>" class="form-control" >
 </div>
...
<label class="col-sm-2 col-sm-2 control-label"><b style="color:red;">*</b> Telephone</label>
 <div class="col-sm-4">
<input type="text" name="contactno" required="required" value="<?php echo htmlentities($row['contactNo']);?>" pattern="0[0-9]{9}" title="Phone number with 7-9 and remaing 9 digit with 0-9" class="form-control">
</div>
</div>0913620627


<div class="form-group">
  <label class="col-sm-2 col-sm-2 control-label"><b style="color:red;">*</b>  Woreda</label>
 <div class="col-xs-4">
 
<input type="text" name="woreda" id="woreda" value="<?php echo htmlentities($row['woreda']);?>" required="required" class="form-control">
</div>
<label class="col-sm-2 col-sm-2 control-label"><b style="color:red;">*</b>  Zone</label>
 <div class="col-xs-4">
    
<input type="text" name="zone" id="zone" value="<?php echo htmlentities($row['zones']);?>" required="required" class="form-control">
</div>
</div>

<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label"><b style="color:red;">*</b> Region</label>
<div class="col-sm-4">
...
<select name="state" required="required" class="form-control">
	...
	while ($optionData=mysqli_fetch_array($sql)) {
       
    $option =$optionData['stateName'];
		
    ?>
    <?php
    if(!empty($state) && $state== $option){
    ?>
