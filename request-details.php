...
<a href="#" onclick="window.open('view_coc.php?cid=<?php echo $cid; ?>', 'popupWindow', 'width=900,height=900,toolbar=no,title=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes'); return false;">
  View COC File
</a>
